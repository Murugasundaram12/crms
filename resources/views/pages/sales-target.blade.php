...
<!-- Page Header -->
                ...
                <ul class="nav nav-tabs nav-bordered mb-4" role="tablist">
                    <li class="nav-item">
                        <a href="{{ route('page', ['slug' => 'sales-target']) }}" class="nav-link active border-3 bg-transparent">
                            <span class="d-md-inline-block">User</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('page', ['slug' => 'sales-target-team']) }}" class="nav-link border-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="sales-target-list">
...
<script src="{{ asset('assets/json/sales-target-list.js') }}"></script>
@endpush
