...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Teams<span class="badge badge-soft-primary ms-2">150</span></h4>
                ...
                <div class="card border-0 rounded-0">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-modal"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add Team</a>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#team" aria-expanded="false" aria-controls="team">Team Name</a>
                                                    </div>
                                                    <div class="filter-set-contents accordion-collapse collapse" id="team" data-bs-parent="#accordionExample">
                                                ...
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#type" aria-expanded="false" aria-controls="type">Team Lead</a>
                                                    </div>
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="teams-list">
...
<script src="{{ asset('assets/json/teams-list.js') }}"></script>
@endpush
