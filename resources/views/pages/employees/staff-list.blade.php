...
@section('title', 'Staff Directory List')
                ...
                <div class="card border-0 rounded-0">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <div class="d-flex align-items-center gap-2 flex-wrap">   
                            <div class="d-flex align-items-center shadow p-2 rounded border view-icons bg-white">
                                <a href="{{ route('page', ['slug' => 'staff-directory-list']) }}" class="btn btn-sm p-1 border-0 fs-14 active"><i class="ti ti-list-tree"></i></a>
                                <a href="{{ route('page', ['slug' => 'staff-directory-grid']) }}" class="flex-shrink-0 btn btn-sm p-1 border-0 ms-1 fs-14"><i class="ti ti-grid-dots"></i></a>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="staff-directory-list">
...
<script src="{{ asset('assets/json/staff-directory-list.js') }}"></script>
@endpush
