...
@section('title', 'Lead Aging Reports')
...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Lead Aging </h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item" aria-current="page">Reports </li>
                                <li class="breadcrumb-item active" aria-current="page">Lead Aging </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="row row-gap-3">
                    <div class="col-xl-5">
                        <div class="card">
                            <div class="card-header">
                                <div class="mb-0 fw-bold fs-16 text-dark">Risk Level Split</div>
                            </div>
                            <div class="card-body">
                                <div id="risk-level-chart" class="mb-4"></div>
                                <!-- start row -->
                                <div class="row row-gap-4">
                                    <div class="col-sm-6">
                                        <div class="d-flex align-items-center justify-content-between gap-1 mb-0 leads-value">
                                            <p class="mb-0"> <span class="line bg-pink"></span> Critical</p>
                                            <span class="badge badge-tag badge-soft-pink">160 Leads</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="d-flex align-items-center justify-content-between gap-1 mb-0 leads-value"> 
                                            <p class="mb-0"> <span class="line bg-warning"></span> Medium</p>
                                            <span class="badge badge-tag badge-soft-warning">670 Leads</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="d-flex align-items-center justify-content-between gap-1 mb-0 leads-value"> 
                                            <p class="mb-0"> <span class="line bg-danger"></span> High</p>
                                            <span class="badge badge-tag badge-soft-danger">240 Leads</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="d-flex align-items-center justify-content-between gap-1 mb-0 leads-value"> 
                                            <p class="mb-0"> <span class="line bg-success"></span> Low</p>
                                            <span class="badge badge-tag badge-soft-success">340 Leads</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end row -->
                    ...
                    <div class="col-xl-7">
                        <div class="card">
                            <div class="card-header">
                                <div class="mb-0 fw-bold fs-16 text-dark">Aging Bucket Split</div>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            <div class="d-flex align-items-center gap-2 flex-wrap">                                
                                ...
                                <!-- 3rd Drop down -->
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn btn-outline-light shadow px-2" data-bs-toggle="dropdown" data-bs-auto-close="outside"><i class="ti ti-dashboard me-2"></i>Risk Level<i class="ti ti-chevron-down ms-2"></i></a>
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg bg-light p-0">
                                        <div class="filter-set-view p-3">                                            
                                            <div class="accordion" id="accordionExample3">
                                                <div class="filter-set-content mb-0">
                                                    <div class="filter-set-contents accordion-collapse collapse show" id="collapseThreefive" data-bs-parent="#accordionExample3">
                                                        <div class="filter-content-list">
                                                            <ul class="mb-0">
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
...
<script src="{{ asset('assets/json/lead-aging-report.js') }}"></script>
@endpush
