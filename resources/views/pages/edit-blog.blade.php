                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="input-tags form-control border-0 h-100" data-choices data-choices-limit="infinite" data-choices-removeItem type="text" value="Productivity">
                                        <span class="fs-13">Enter value separated by comma</span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Content</label>
                                        <div class="editor pages-editor">
                                            <p>Discover how to optimize tools to boost your sales teamâ€™s productivity and track important metrics.</p>
                                        </div>
                                    </div>
                                    <div class="mb-3">
