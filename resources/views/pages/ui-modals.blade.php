                                            ...
                                            <div class="modal-body">
                                                <div class="auth-brand text-center mt-2 mb-3 position-relative top-0">
                                                    <a href="{{ route('home') }}" class="logo-dark">
                                                        <span><img src="{{ asset('assets/img/logo.svg') }}" alt="dark logo" height="33"></span>
                                                    </a>
                                                    <a href="{{ route('home') }}" class="logo-light">
                                                        <span><img src="{{ asset('assets/img/logo-white.svg') }}" alt="logo" height="33"></span>
                                                    </a>
                                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="auth-brand text-center mt-2 mb-3 position-relative top-0">
                                                    <a href="{{ route('home') }}" class="logo-dark">
                                                        <span><img src="{{ asset('assets/img/logo.svg') }}" alt="dark logo" height="22"></span>
                                                    </a>
                                                    <a href="{{ route('home') }}" class="logo-light">
                                                        <span><img src="{{ asset('assets/img/logo-white.svg') }}" alt="logo" height="22"></span>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="modal-content modal-filled bg-success">
                                            <div class="modal-body p-4">
                                                <div class="text-center">
                                                    ...
                                                    <p class="mt-3">Congratulations! You've achieved success! Ã°Å¸Å½â€° Your hard work, dedication, and perseverance have paid off. Keep up the great work and continue to strive for excellence.</p>
