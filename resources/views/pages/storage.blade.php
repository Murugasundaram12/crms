							...
							<div class="card-body">
								<div class="settings-sidebar">
									...
									<div class="list-group list-group-flush settings-sidebar">
										...
										<a href="{{ route('page', ['slug' => 'storage']) }}" class="d-block p-2 fw-medium active">Storage</a>
										...
										<div class="border rounded p-3 d-flex align-items-center justify-content-between shadow">
											<div class="d-flex align-items-center">
												<span
													...
													<img src="{{ asset('assets/img/icons/storage-icon-01.svg') }}"
									...
									<div class="col-xxl-6 col-sm-6">
										<div class="border rounded p-3 d-flex align-items-center justify-content-between shadow">
											<div class="d-flex align-items-center">
												<span
													class="avatar avatar-lg bg-light-100 border flex-shrink-0 me-2">
													<img src="{{ asset('assets/img/icons/storage-icon-02.svg') }}"
														class="w-auto h-auto" alt="Img">
												</span>
