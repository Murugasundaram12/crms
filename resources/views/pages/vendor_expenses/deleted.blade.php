...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <div>
            <h4 class="mb-1">Vendor Deleted History</h4>
        ...
        <div class="card-header bg-white border-bottom">
            <form class="row g-3 align-items-end m-0" method="GET">
                ...
                <div class="col-12 col-md-6 col-lg-3 d-flex gap-2">
                    ...
                    <a href="{{ route('vendor-expenses.deleted-history') }}" class="btn btn-outline-secondary w-100 shadow-sm">Reset</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-nowrap align-middle mb-0">
                    <thead class="table-light">
                        <tr><th>Vendor</th><th>Paid</th><th>Delete Reason</th><th>Date</th></tr>
                    </thead>
                    <tbody>
