...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Sales Targets</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Sales Settings</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Sales Targets</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <ul class="nav nav-tabs nav-bordered mb-4" role="tablist">
                    <li class="nav-item">
                        <a href="{{ route('page', ['slug' => 'sales-targets-settings']) }}" class="nav-link active border-3 bg-transparent">
                            <span class="d-md-inline-block">User</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('page', ['slug' => 'sales-targets-teams-settings']) }}" class="nav-link border-3">
                            <span class="d-md-inline-block">Teams</span>
                        </a>
                    </li>
                </ul>
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-modal"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add Target</a>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">User</a>
                                                    </div>
                                                ...
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#Status" aria-expanded="false" aria-controls="Status">Period</a>
                                                    </div>
                                                ...
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#Status2" aria-expanded="false" aria-controls="Status2">Status</a>
                                                    </div>
                                                    <div class="filter-set-contents accordion-collapse collapse" id="Status2" data-bs-parent="#accordionExample">
                                                        <div class="filter-content-list bg-light rounded border p-2 shadow mt-2">
                                                            <ul>
                                                                <li>
                                                                     <label class="dropdown-item px-2 d-flex align-items-center">
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="sales-target-settings">
...
<script src="{{ asset('assets/json/sales-target-settings.js') }}"></script>
@endpush
