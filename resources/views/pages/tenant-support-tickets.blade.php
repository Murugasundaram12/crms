                ...
                <div class="card border-0 rounded-0">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <div class="d-inline-flex align-items-center gap-3">
                            <div class="d-inline-flex align-items-center shadow p-1 rounded border view-icons bg-white">
                                <a href="{{ route('page', ['slug' => 'tenant-support-tickets']) }}" class="btn p-2 border-0 fs-14 active"><i class="ti ti-list-tree"></i></a>
                                <a href="{{ route('page', ['slug' => 'tenant-support-tickets-grid']) }}" class="flex-shrink-0 btn p-2 border-0 ms-1 fs-14"><i class="ti ti-grid-dots"></i></a>
                            </div>
                    ...
                    <div class="card-body">
						...
						<div class="table-responsive custom-table">
							<table class="table table-nowrap" id="support-tickets">
...
<script src="{{ asset('assets/json/support-tickets.js') }}"></script>
@endpush
