                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Use the <code>focus</code> trigger to dismiss popovers on the userÃ¢â‚¬â„¢s next click of a different element than the toggle element.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <p>Elements with the <code>disabled</code> attribute arenÃ¢â‚¬â„¢t interactive, meaning users cannot hover or click them to trigger a popover (or tooltip). As a workaround, youÃ¢â‚¬â„¢ll want to trigger the popover from a wrapper <code>&lt;div&gt;</code>                                    or <code>&lt;span&gt;</code> and override the
