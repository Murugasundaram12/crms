...
@section('title', 'Pipeline Stage Report')
...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Pipeline Stage Report</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item">Reports</li>
                                <li class="breadcrumb-item active" aria-current="page">Pipeline Stage Report</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-xl-7 d-flex">		
						<div class="card flex-fill">
							<div class="card-header">
								<div class="mb-0 fs-16 fw-bold text-dark">No of Deals</div>
							</div>
							<div class="card-body">
                    ...
                    <div class="col-md-12 col-xl-5 d-flex">		
						<div class="card flex-fill">
							<div class="card-header">
								<div class="mb-0 fs-16 fw-bold text-dark">Win Rate</div>
							</div>
							<div class="card-body">
								<div id="win-rate"></div>
							</div>
                ...
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="pipeline-stage">
...
<script src="{{ asset('assets/json/pipeline-stage.js') }}"></script>
@endpush
