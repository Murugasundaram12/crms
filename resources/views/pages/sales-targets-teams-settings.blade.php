...
<!-- Page Header -->
                ...
                <ul class="nav nav-tabs nav-bordered mb-4" role="tablist">
                    <li class="nav-item">
                        <a href="{{ route('page', ['slug' => 'sales-targets-settings']) }}" class="nav-link border-3 bg-transparent">
                            <span class="d-md-inline-block">User</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('page', ['slug' => 'sales-targets-teams-settings']) }}" class="nav-link border-3 active bg-transparent">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#owner" aria-expanded="false" aria-controls="owner">Team</a>
                                                    </div>
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="sales-target-teams-settings">
...
<script src="{{ asset('assets/json/sales-target-teams-settings.js') }}"></script>
@endpush
