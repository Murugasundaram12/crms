                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap">                                
                                ...
                                <div class="d-flex align-items-center shadow p-1 rounded border view-icons bg-white">
									<a href="{{ route('page', ['slug' => 'leads-list']) }}" class="btn btn-sm p-1 border-0 fs-14 active"><i class="ti ti-list-tree"></i></a>
									<a href="{{ route('page', ['slug' => 'leads']) }}" class="flex-shrink-0 btn btn-sm p-1 border-0 ms-1 fs-14"><i class="ti ti-grid-dots"></i></a>
								</div>
                            </div>
                        </div>
                        <!-- table header -->
...
<script src="{{ asset('assets/json/leads-list.js') }}"></script>
@endpush
