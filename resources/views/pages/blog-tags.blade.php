...
<!-- Page Header -->
                ...
                <div class="card border-0 rounded-0">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_tags"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add Blog Tag</a>
                    </div>
					<div class="card-body">
						...
						<div class="table-responsive custom-table">
                            <table class="table table-nowrap" id="tags_list">
...
<script src="{{ asset('assets/json/tags-list.js') }}"></script>
@endpush
