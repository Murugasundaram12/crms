                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <a href="{{ route('page', ['slug' => 'activity-mail']) }}" class="btn btn-icon btn-outline-light shadow active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Mail"><i class="ti ti-mail"></i></a>
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="activity-mail">
...
<script src="{{ asset('assets/json/activity-mail.js') }}"></script>
@endpush
