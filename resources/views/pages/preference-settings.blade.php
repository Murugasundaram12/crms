...
@section('title', 'Settings - Preference')
							...
							<div class="card-body">
								<div class="settings-sidebar">
									...
									<div class="list-group list-group-flush settings-sidebar">
										...
										<a href="{{ route('page', ['slug' => 'preference-settings']) }}" class="d-block p-2 fw-medium active">Preference</a>
					...
					<div class="col-xl-9 col-lg-12">
						...
						<div class="card mb-0">
							<div class="card-body">
								...
								<form action="https://crms.dreamstechnologies.com/html/template/preference-settings.html">
												...
												<div class="card border mb-3">
													<div
														...
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-01.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-02.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-03.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-04.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-06.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-07.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-08.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-09.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-10.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-11.svg') }}" alt="Img">
											...
											<div class="col-xxl-4 col-sm-6">
												<div class="card border mb-3">
													<div
														class="card-body d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<img src="{{ asset('assets/img/icons/preference-12.svg') }}" alt="Img">
