                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Similar to the contextual text color classes, set the background of an element to any contextual class. Background utilities <strong>do not set <code>color</code></strong>, so in some cases youÃ¢â‚¬â„¢ll want to use <code>.text-*</code>color utilities.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Similar to the contextual text color classes, set the background of an element to any contextual class. Background utilities do not set <code>color</code>, so in some cases youÃ¢â‚¬â„¢ll want to use <code>.text-*</code> <a href="https://getbootstrap.com/docs/5.3/utilities/colors/">color utilities</a>. </p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use border utilities to <b>add</b> an elementÃ¢â‚¬â„¢s borders. Choose from all borders or one at a time.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use border utilities to <b>remove</b> an elementÃ¢â‚¬â„¢s borders. Choose from all borders or one at a time.</p>
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    <div class="text-center">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-2">
                                    <img src="{{ asset('assets/img/users/avatar-2.jpg') }}" class="avatar-lg rounded" alt="rounded">
                                    <img src="{{ asset('assets/img/users/avatar-2.jpg') }}" class="avatar-lg rounded-top" alt="rounded-top">
                                    <img src="{{ asset('assets/img/users/avatar-2.jpg') }}" class="avatar-lg rounded-end" alt="rounded-end">
                                    <img src="{{ asset('assets/img/users/avatar-2.jpg') }}" class="avatar-lg rounded-bottom" alt="rounded-bottom">
                                    <img src="{{ asset('assets/img/users/avatar-2.jpg') }}" class="avatar-lg rounded-start" alt="rounded-start">
                                    <img src="{{ asset('assets/img/users/avatar-2.jpg') }}" class="avatar-lg rounded-circle" alt="rounded-circle">
                                    <img src="{{ asset('assets/img/users/avatar-10.jpg') }}" class="avatar-lg w-auto rounded-pill" alt="rounded-pill">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-2">
                                    <img src="{{ asset('assets/img/users/avatar-4.jpg') }}" class="avatar-lg rounded-0" alt="rounded-0">
                                    <img src="{{ asset('assets/img/users/avatar-4.jpg') }}" class="avatar-lg rounded-1" alt="rounded-1">
                                    <img src="{{ asset('assets/img/users/avatar-4.jpg') }}" class="avatar-lg rounded-2" alt="rounded-2">
                                    <img src="{{ asset('assets/img/users/avatar-4.jpg') }}" class="avatar-lg rounded-3" alt="rounded-3">
                                    <img src="{{ asset('assets/img/users/avatar-4.jpg') }}" class="avatar-lg rounded-4" alt="rounded-4">
                                    <img src="{{ asset('assets/img/users/avatar-4.jpg') }}" class="avatar-lg rounded-5" alt="rounded-5">
                                </div>
                            </div> <!-- end card body -->
                        </div> <!-- end card -->
                    </div> <!-- end col -->
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="d-flex align-items-start flex-wrap gap-3 text-center">
									<div>
										<img src="{{ asset('assets/img/media/img-2.jpg') }}" class="object-fit-contain border rounded avatar-xl" alt="...">
										<p class="mt-1 mb-0"><code class="user-select-all">.object-fit-contain</code></p>
									</div>
									<div>
										<img src="{{ asset('assets/img/media/img-2.jpg') }}" class="object-fit-cover border rounded avatar-xl" alt="...">
										<p class="mt-1 mb-0"><code class="user-select-all">.object-fit-cover</code></p>
									</div>
									<div>
										<img src="{{ asset('assets/img/media/img-2.jpg') }}" class="object-fit-fill border rounded avatar-xl" alt="...">
										<p class="mt-1 mb-0"><code class="user-select-all">.object-fit-fill</code></p>
									</div>
									<div>
										<img src="{{ asset('assets/img/media/img-2.jpg') }}" class="object-fit-scale border rounded avatar-xl" alt="...">
										<p class="mt-1 mb-0"><code class="user-select-all">.object-fit-scale</code></p>
									</div>
									<div>
										<img src="{{ asset('assets/img/media/img-2.jpg') }}" class="object-fit-none border rounded avatar-xl" alt="...">
					...
					<div class="col-xl-12">
						<div class="card">
							...
							<div class="card-body pb-0">
								<p class="text-muted">Use <code>z-index</code> utilities to stack elements on top of one another. Requires a <code>position</code> value other than <code>static</code>, which can be set with custom styles or using our <a href="https://crms.dreamstechnologies.com/docs/5.3/utilities/position/">position utilities</a>.</p>
