                                                            ...
                                                            <ul class="mb-0">
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        ...
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border rounded-circle me-2 p-1"><img src="{{ asset('assets/img/icons/company-icon-01.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>NovaWave LLC
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox">
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border rounded-circle me-2 p-1"><img src="{{ asset('assets/img/icons/company-icon-02.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>BlueSky Industries
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox">
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border rounded-circle me-2 p-1"><img src="{{ asset('assets/img/icons/company-icon-03.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>SilverHawk
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox">
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border rounded-circle me-2 p-1"><img src="{{ asset('assets/img/icons/company-icon-04.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>SummitPeak
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox">
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border rounded-circle me-2 p-1"><img src="{{ asset('assets/img/icons/company-icon-05.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>RiverStone Ventur
                                                                    </label>
                                                                </li>
                                                                <li>
...
<script src="{{ asset('assets/json/quotations-list.js') }}"></script>
@endpush
