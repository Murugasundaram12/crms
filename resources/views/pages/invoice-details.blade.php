...
<!-- start row-->
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        ...
                        <!-- start page header -->
                        <h6 class="mb-3 fs-14"> <a href="{{ route('page', ['slug' => 'invoice']) }}"><i class="ti ti-arrow-left me-1"></i>Invoices</a></h6>
                        <!-- end page header -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-1 border-bottom pb-3 mb-3">
                                    <img src="{{ asset('assets/img/logo.svg') }}" class="invoice-light-logo" width="200" alt="Img">
                                    <img src="{{ asset('assets/img/logo-white.svg') }}" class="dark-logo" width="200" alt="Img">
                                ...
                                <div class="pb-3 mb-3 border-1 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <div>
                                        <div class=" mb-3">
                                            ...
                                            <p class="mb-0"> The Payment must be returned in the same condition. </p>
                                        </div>

                                        <div>
                                            <h6 class="mb-1 fs-14 fw-semibold"> Notes </h6>
                                            <p class="mb-0"> All charges are final and include applicable taxes, fees, and additional costs.</p>
                                        </div>
                                    </div>
