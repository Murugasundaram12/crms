                ...
                <div class="card border-0 rounded-0">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <div class="d-inline-flex align-items-center gap-3">
                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_timesheet"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add Log</a>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            <div class="accordion" id="accordionExample">
                                                ...
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" data-bs-toggle="collapse" data-bs-target="#employee" aria-expanded="true" aria-controls="employee">Employee Name</a>
                                                    </div>
						...
						<div class="table-responsive custom-table">
							<table class="table table-nowrap" id="timesheet">
...
<script src="{{ asset('assets/json/timesheet.js') }}"></script>
@endpush
