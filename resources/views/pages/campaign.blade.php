...
<!-- Page Header -->
                ...
                <div class="campaign-tab">
                    <ul class="nav nav-tabs nav-bordered mb-4">
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'campaign']) }}" class="nav-link active bg-transparent text-primary">Active Campaign<span class="fs-10 fw-normal ms-1 text-body">24</span></a>
                        </li>
                        <li class="nav-item">
...
<script src="{{ asset('assets/json/campaign-list.js') }}"></script>
@endpush
