                ...
                <div class="card border-0 rounded-0">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <div class="d-inline-flex align-items-center gap-3">
                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_milestone"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add Milestone</a>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            <div class="accordion" id="accordionExample">
                                                            ...
                                                            <ul class="mb-0">
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        ...
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border bg-white p-1"><img src="{{ asset('assets/img/icons/time-icon-1.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>Trip Flow
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox">
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border bg-white p-1"><img src="{{ asset('assets/img/icons/time-icon-2.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>Connect Hub
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox">
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border bg-white p-1"><img src="{{ asset('assets/img/icons/time-icon-3.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>Gig Market
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox">
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border bg-white p-1"><img src="{{ asset('assets/img/icons/time-icon-4.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>Book Ease
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox">
                                                                        <span class="avatar avatar-xs rounded-circle me-2 border bg-white p-1"><img src="{{ asset('assets/img/icons/time-icon-5.svg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>Retail POS
                                                                    </label>
                                                                </li>
                                                                <li>
                                                ...
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" data-bs-toggle="collapse" data-bs-target="#employee" aria-expanded="true" aria-controls="employee">Assignee</a>
                                                    </div>
                                                    <div class="filter-set-contents accordion-collapse collapse" id="employee" data-bs-parent="#accordionExample">
                                                        <div class="filter-content-list bg-light rounded border p-2 shadow mt-2">
                                                            <div class="mb-2">
                                                                <div class="input-icon-start input-icon position-relative">
                                                                    <span class="input-icon-addon fs-12">
						...
						<div class="table-responsive custom-table">
							<table class="table table-nowrap" id="milestone-id">
...
<script src="{{ asset('assets/json/milestone.js') }}"></script>
@endpush
