...
<!-- Page Header -->
                ...
                <div class="campaign-tab">
                    <ul class="nav nav-tabs nav-bordered mb-4">
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'whatsapp-campaign']) }}" class="nav-link active bg-transparent text-primary">Active Campaign</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'whatsapp-campaign-completed']) }}" class="nav-link bg-transparent">Completed Campaign</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'whatsapp-campaign-archieved']) }}" class="nav-link bg-transparent">Archived Campaign</a>
                        </li>
                    </ul>
                </div>
                <!-- Campaign Tab -->
...
<script src="{{ asset('assets/json/whatsapp-campaign.js') }}"></script>
@endpush
