                                    ...
                                    <div>
                                        <a href="javscript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                            <span class="d-inline-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/liked-page-01.svg') }}" class="me-2" alt="Img">Dribble
                                            </span>
                                            <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                        </a>
                                        <a href="javscript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                            <span class="d-inline-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/liked-page-02.svg') }}" class="me-2" alt="Img">UI/UX Designs
                                            </span>
                                            <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                        </a>
                                        <a href="javscript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1">
                                            <span class="d-inline-flex align-items-center">
                                                <img src="{{ asset('assets/img/icons/liked-page-03.svg') }}" class="me-2" alt="Img">Figma Update
                                            </span>
                                            <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                        </a>
                                        <div>
                                            <div class="more-menu-3">
                                                <a href="javscript:void(0);" class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                                    <span class="d-inline-flex align-items-center">
                                                        <img src="{{ asset('assets/img/icons/liked-page-04.svg') }}" class="me-2" alt="Img">I Am Techie
                                                    </span>
                                                    <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                                </a>
                                            </div>
                        ...
                        <div>
                                    ...
                                    <form action="https://crms.dreamstechnologies.com/html/template/social-feed.html">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-photo fs-16"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-link fs-16"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-paperclip fs-16"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-video fs-16"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-hash fs-16"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-map-pin-heart fs-16"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-mood-smile fs-16"></i></a>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-refresh fs-16"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-trash fs-16"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-world fs-16"></i></a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('assets/img/icons/channel-01.svg') }}" alt="Img">
                                        </a>
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('assets/img/icons/channel-02.svg') }}" alt="Img">
                                        </a>
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('assets/img/icons/channel-03.svg') }}" alt="Img">
                                        </a>
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('assets/img/icons/channel-04.svg') }}" alt="Img">
                                        </a>
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('assets/img/icons/channel-05.svg') }}" alt="Img">
                                        </a>
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('assets/img/icons/channel-06.svg') }}" alt="Img">
                                        </a>
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('assets/img/icons/channel-07.svg') }}" alt="Img">
                                        </a>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                            ...
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('assets/img/profiles/avatar-03.jpg') }}" alt="Img"></a>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-edit me-2"></i>Edit</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-eye me-2"></i>Hide Post</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-report me-2"></i>Report</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-trash-x me-2"></i>Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-2">
                                        <p class="text-dark fw-medium">"Believe in yourself and all that you are. Know that there is something inside you that is greater than any obstacle.
                                            ...
                                            <a href="javascript:void(0);" class="text-info link-hover">#Inspiration</a> Ã°Å¸Å’Å¸"
                                        </p>
                                    </div>
                                    <div class="mb-2">
                                        <img src="{{ asset('assets/img/social/social-feed-01.jpg') }}" class="rounded img-fluid" alt="Img">
                                    </div>
                                    <div class="row g-2 mb-2">
                                        <div class="col-md-3">
                                            <div class="img-full-view">
                                                <a href="{{ asset('assets/img/social/gallery-big-01.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                    <img src="{{ asset('assets/img/social/gallery-01.jpg') }}" class="rounded img-fluid" alt="img">
                                        ...
                                        <div class="col-md-3">
                                            <div class="img-full-view">
                                                <a href="{{ asset('assets/img/social/gallery-big-03.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                    <img src="{{ asset('assets/img/social/gallery-03.jpg') }}" class="rounded img-fluid" alt="img">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="img-full-view">
                                                <a href="{{ asset('assets/img/social/gallery-big-02.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                    <img src="{{ asset('assets/img/social/gallery-02.jpg') }}" class="rounded img-fluid" alt="img">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="img-full-view">
                                                <a href="{{ asset('assets/img/social/gallery-big-04.jpg') }}" data-fancybox="gallery" class="gallery-item">
                                                    <img src="{{ asset('assets/img/social/gallery-04.jpg') }}" class="rounded img-fluid" alt="img">
                                                    <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-heart-filled text-danger"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-share"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-message-star"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-bookmark-filled text-warning"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start">
                                        <a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{ asset('assets/img/profiles/avatar-04.jpg') }}" alt="Img"></a>
                            ...
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('assets/img/profiles/avatar-05.jpg') }}" alt="Img"></a>
                                            <div>
                                ...
                                <div class="card-body">
                                    <div class="mb-2">
                                        <p class="text-dark fw-medium">
                                            ...
                                            <a href="javascript:void(0);" class="text-info link-hover"> #Wellness</a> Ã°Å¸â€™Â§
                                        </p>
                                    </div>
                                    <div class="card shadow-none mb-3">
                                        <div class="card-img card-img-hover rounded-0">
                                            <a href="javascript:void(0);" class="rounded-top"><img src="{{ asset('assets/img/social/social-feed-02.jpg') }}" class="rounded-top img-fluid" alt="Img"></a>
                                        </div>
                                        <div class="card-body p-2">
                                            <h6 class="mb-1 text-truncate"><a href="javascript:void(0);">Drinking water boosts skin health and beauty. Stay hydrated!Ã°Å¸â€™Â§</a></h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-heart"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-share"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-message-star"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-bookmark"></i></a>
                                        </div>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                            ...
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                                        <div class="d-flex align-items-center">
                                            <span class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('assets/img/profiles/avatar-04.jpg') }}" alt="Img"></span>
                                            <div>
                                ...
                                <div class="card-body">
                                    <div class="mb-2">
                                        <p class="text-dark fw-medium">
                                            ...
                                            <a href="javascript:void(0);" class="text-info link-hover">  #Innovation</a> Ã°Å¸Å½â€°
                                        </p>
                                    </div>
                                    <div class="mb-2">
                                        <img src="{{ asset('assets/img/social/social-feed-03.jpg') }}" class="rounded img-fluid" alt="Img">
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                        <div class="d-flex align-items-center flex-wrap row-gap-3">
                                            <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="view-all text-center mb-3">
                                            <a href="javascript:void(0);" class="viewall-button link-primary fw-medium">View All 200 Comments</a>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start">
                                        <span class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{ asset('assets/img/profiles/avatar-05.jpg') }}" alt="Img"></span>
                                        <input type="text" class="form-control" placeholder="Enter Comments">
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                                    ...
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                        <div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('assets/img/profiles/avatar-09.jpg') }}" alt="Img">
                                                    </a>
                                                    <div>
                                                        <h6 class="d-inline-flex align-items-center fs-14 fw-medium mb-1">
                                        ...
                                        <div>
                                            <a href="javascript:void(0);" class="btn btn-outline-white text-dark w-100">View All <i class="ti ti-arrow-right ms-2"></i></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel">
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('assets/img/profiles/avatar-11.jpg') }}" alt="Img">
                                                    </a>
                                                    <div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('assets/img/profiles/avatar-10.jpg') }}" alt="Img">
                                                    </a>
                                                    <div>
                                                        <h6 class="d-inline-flex align-items-center fs-14 fw-medium mb-1">
                                                            <a href="javascript:void(0);">Harvey Smith</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bg-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <a href="javascript:void(0);" class="d-flex align-items-center">
                                            <span><img src="{{ asset('assets/img/icons/feeds-01.svg') }}" class="me-2" alt="Img"></span>
                                ...
                                <div class="bg-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <a href="javascript:void(0);" class="d-flex align-items-center">
                                            <span><img src="{{ asset('assets/img/icons/feeds-02.svg') }}" class="me-2" alt="Img"></span>
                                ...
                                <div class="bg-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <a href="javascript:void(0);" class="d-flex align-items-center">
                                            <span><img src="{{ asset('assets/img/icons/feeds-03.svg') }}" class="me-2" alt="Img"></span>
                                ...
                                <div class="bg-light rounded p-2">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <a href="javascript:void(0);" class="d-flex align-items-center">
                                            <span><img src="{{ asset('assets/img/icons/feeds-04.svg') }}" class="me-2" alt="Img"></span>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-img card-img-hover mb-3">
                                    <a href="javascript:void(0);" class="rounded"><img src="{{ asset('assets/img/social/social-feed-04.jpg') }}" class="rounded img-fluid w-100" alt="Img"></a>
                                </div>
                                <h6 class="text-center fs-14"><a href="javascript:void(0);">Enjoy Unlimited Access on a small price monthly.</a></h6>
                                <div class="mt-3">
                                    <a href="javascript:void(0);" class="btn btn-outline-white text-dark w-100">Upgrade Now <i class="ti ti-arrow-right ms-2"></i></a>
                                </div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
