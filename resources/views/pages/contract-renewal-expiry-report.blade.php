...
@section('title', 'Contract Renewal & Expiry Report')
...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Contract Renewal & Expiry Report <span class="badge badge-soft-primary ms-2">15</span></h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item">Document Reports</li>
                                <li class="breadcrumb-item active" aria-current="page">Contract Renewal & Expiry Report</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="col-12">		
						<div class="card">
							<div class="card-header border-0">
								<div class="mb-0 fs-16 fw-bold text-dark">Renewal vs Expiry Comparision</div>
							</div>
							<div class="card-body pt-0">
								<div id="renewal_expiry"></div>
                                <div class="d-flex alig-items-center justify-content-center text-center gap-3">
                                    <span class="fs-12 text-purple fw-medium">Renewed Contracts</span>
                                    <span class="fs-12 text-danger fw-medium">Expired Contracts</span>
                                </div>
							</div>
                        </div>
					</div>
                ...
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle btn btn-outline-light px-2 shadow" data-bs-toggle="dropdown" aria-expanded="false"><i class="ti ti-users me-2"></i>Contract Name</a>
                                    <div class="dropdown-menu">
                                        <div class="mb-2">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item">NovaWave LLC</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"> BlueSky Industries</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"> Silver Hawk</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"> Sophia Parker</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"> Summit LLC</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"> RiverStone Ltd</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"> Brightbridge Corp</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="contract-renewal">
...
<script src="{{ asset('assets/json/contract-renewal.js') }}"></script>
@endpush
