                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <a href="{{ route('page', ['slug' => 'activity-meeting']) }}" class="btn btn-icon btn-outline-light shadow active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Meeting"><i class="ti ti-user-share"></i></a>
                                <div class="dropdown">
...
<script src="{{ asset('assets/json/activity-meeting.js') }}"></script>
@endpush
