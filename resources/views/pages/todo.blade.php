...
<!-- Page Header -->
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                    ...
                    <ul class="d-flex align-items-center flex-shrink-0 list-unstyled mb-0">
                        <li>
                            <a href="{{ route('page', ['slug' => 'todo']) }}" class="btn btn-icon btn-sm bg-primary text-white active me-2"><i class="ti ti-layout-grid"></i></a>
                        </li>
                        <li>
                            <a href="{{ route('page', ['slug' => 'todo-list']) }}" class="btn btn-icon btn-white btn-sm text-dark me-2"><i class="ti ti-list-tree"></i></a>
                        </li>
                    </ul>
                </div>
