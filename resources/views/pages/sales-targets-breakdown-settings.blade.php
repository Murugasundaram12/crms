...
@section('title', 'Sales Target Breakdown')
...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Sales Target Breakdown</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Sales Settings</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Sales Target Breakdown</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="sales-target-breakdown-settings">
...
<script src="{{ asset('assets/json/sales-target-breakdown-settings.js') }}"></script>
@endpush
