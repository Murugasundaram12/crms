...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Domains<span class="badge badge-soft-primary ms-2">198</span></h4>
                                        ...
                                        <td>
                                            <div class="dropdown table-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#domain_approved">
                                                        <i class="ti ti-eye text-blue-light me-1"></i> Preview
                                                    </a>
                                                    <a class="dropdown-item" href="#">
                                                        <i class="ti ti-download text-blue me-1"></i>Download
                                                    </a>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_domain">
