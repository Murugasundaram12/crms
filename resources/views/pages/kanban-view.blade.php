                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                        ...
                        <div class="d-flex align-items-center flex-wrap row-gap-3">
                            ...
                            <div class="input-group input-group-flat w-auto">
                                <span class="input-group-text border-end-0 border-start">
                    ...
                    <div class="card-body overflow-hidden">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="dropdown-toggle btn btn-outline-white bg-white text-dark d-inline-flex align-items-center drop-arrow-none" data-bs-toggle="dropdown">
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle btn  bg-white btn-outline-white text-dark d-inline-flex align-items-center drop-arrow-none" data-bs-toggle="dropdown">
                                        ...
                                        <div class="card kanban-card mb-2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <img src="{{ asset('assets/img/icons/kanban-arrow.svg') }}" class="w-auto h-auto" alt="Img">
                                                </span>
                                                    <h6 class="d-flex align-items-center fs-16 mb-0">Doccure</h6>
                                                </div>
                                        ...
                                        <div class="card kanban-card mb-2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <h6 class="d-flex align-items-center fs-16 mb-0">Dreams Tour</h6>
                                                </div>
                                                <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                                                    <div class="me-2 pe-2 border-end">
                                                        <span class="fw-medium fs-12 d-block mb-1">Budget</span>
                                        ...
                                        <div class="card kanban-card mb-2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <h6 class="d-flex align-items-center fs-16 mb-0">Dreams Gigs</h6>
                                                </div>
                                                <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                                                    <div class="me-2 pe-2 border-end">
                                                        <span class="fw-medium fs-12 d-block mb-1">Budget</span>
                                        ...
                                        <div class="card kanban-card mb-2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <h6 class="d-flex align-items-center fs-16 mb-0">Dreams Rent</h6>
                                                </div>
                                                <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                                                    <div class="me-2 pe-2 border-end">
                                                        <span class="fw-medium fs-12 d-block mb-1">Budget</span>
                                        ...
                                        <div class="card kanban-card mb-2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <h6 class="d-flex align-items-center fs-16 mb-0">Dreams Sports</h6>
                                                </div>
                                                <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                                                    <div class="me-2 pe-2 border-end">
                                                        <span class="fw-medium fs-12 d-block mb-1">Budget</span>
                                        ...
                                        <div class="card kanban-card mb-2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <h6 class="d-flex align-items-center fs-16 mb-0">Dreams Estate</h6>
                                                </div>
                                                <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                                                    <div class="me-2 pe-2 border-end">
                                                        <span class="fw-medium fs-12 d-block mb-1">Budget</span>
