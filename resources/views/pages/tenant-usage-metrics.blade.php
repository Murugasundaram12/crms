...
@section('title', 'Tenant Usage Metrices')
...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Tenant Usage Metrices<span class="badge badge-soft-primary ms-2">125</span></h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Tenant Usage Metrices</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            <div class="accordion" id="accordionExample">
                                                ...
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#owner" aria-expanded="false" aria-controls="owner">Plan</a>
                                                    </div>
						...
						<div class="table-responsive custom-table">
							<table class="table table-nowrap" id="usage-metrices">
...
<script src="{{ asset('assets/json/usage-metrices.js') }}"></script>
@endpush
