                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">
                                    In the example below, we take a typical card component and recreate it with placeholders applied to create a Ã¢â‚¬Å“loading cardÃ¢â‚¬Â. Size and proportions are the same between the two.
                                </p>
