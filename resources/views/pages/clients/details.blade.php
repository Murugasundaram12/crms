...
<!-- Page Header -->
                ...
                <div class="row">
					<div class="col-md-12">
						...
						<div class="mb-3">
							<a href="{{ route('page', ['slug' => 'contacts']) }}"><i class="ti ti-arrow-narrow-left me-1"></i>Back to Contacts</a>
						</div>
							...
							<div class="card-body p-3">
								...
								<div class="border-bottom mb-3 pb-3">
									<div class="d-flex align-items-center mb-2">
										...
										<p class="mb-0"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d6b2b7a4bab3b3b996b3aeb7bba6bab3f8b5b9bb">[email&#160;protected]</a></p>
									</div>
									<div class="d-flex align-items-center mb-2">
										<span class="avatar avatar-xs bg-light p-0 flex-shrink-0 rounded-circle text-dark me-2">
								...
								<div class="mb-3">
									<div class="d-flex align-items-center">
										<span class="avatar avatar-lg rounded me-2 border">
											<img src="{{ asset('assets/img/icons/google-icon.svg') }}" alt="Img" class="img-fluid w-auto h-auto">
										</span>
										<div>
										...
										<div class="card border shadow-none mb-3">
											<div class="card-body p-3">
												<div class="d-flex flex-wrap row-gap-2">
													...
													<div>
														<h6 class="fw-medium mb-1 d-inline-flex align-items-center fs-14 flex-wrap">Meeting With <span class="avatar avatar-xs avatar-rounded mx-2"><img src="{{ asset('assets/img/profiles/avatar-19.jpg') }}" alt="img"></span> Abraham</h6>
