                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <p class="text-muted"><a href="{{ route('page', ['slug' => 'ui-utilities']) }}">Colored link helpers</a> have been updated to pair with our link utilities. Use the new utilities to modify the link opacity, underline opacity, and underline offset.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Change the alpha opacity of the link <code>rgba()</code> color value with utilities. Please be aware that changes to a colorÃ¢â‚¬â„¢s opacity can lead to links with <em>insufficient</em> contrast.</p>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Change the underlineÃ¢â‚¬â„¢s color independent of the link text color.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Change the underlineÃ¢â‚¬â„¢s opacity. Requires adding <code>.link-underline</code> to first set an <code>rgba()</code> color we use to then modify the alpha opacity.</p>
