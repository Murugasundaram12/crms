...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Contracts<span class="badge badge-soft-primary ms-2">123</span></h4>
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap">                                
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            <div class="accordion" id="accordionExample">
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#project" aria-expanded="false" aria-controls="project">Contracts Id</a>
                                                    </div>
                                                ...
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#Status" aria-expanded="false" aria-controls="Status">Coustomer</a>
                                                    </div>
                                                ...
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#type" aria-expanded="false" aria-controls="type">Contract Type</a>
                                                    </div>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="{{ route('page', ['slug' => 'contracts-list']) }}" class="btn btn-primary w-100">Filter</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center shadow p-1 rounded border view-icons bg-white">
									<a href="{{ route('page', ['slug' => 'contracts-list']) }}" class="btn btn-sm p-1 border-0 fs-14 active"><i class="ti ti-list-tree"></i></a>
									<a href="{{ route('page', ['slug' => 'contracts']) }}" class="flex-shrink-0 btn btn-sm p-1 border-0 ms-1 fs-14"><i class="ti ti-grid-dots"></i></a>
								</div>
                            </div>
                        </div>
                        <!-- table header -->
...
<script src="{{ asset('assets/json/contracts-list.js') }}"></script>
@endpush
