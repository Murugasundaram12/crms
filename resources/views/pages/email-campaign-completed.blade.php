...
@section('title', 'Email Campaign Completed')
...
<!-- Page Header -->
                ...
                <div class="campaign-tab">
                    <ul class="nav nav-tabs nav-bordered mb-4">
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'email-campaign']) }}" class="nav-link bg-transparent">Active Campaign</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'email-campaign-completed']) }}" class="nav-link active bg-transparent  text-primary">Completed Campaign</a>
                        </li>
                        <li class="nav-item">
...
<script src="{{ asset('assets/json/email-campaign-completed.js') }}"></script>
@endpush
