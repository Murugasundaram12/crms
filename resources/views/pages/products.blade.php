...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Products <span class="badge badge-soft-primary ms-2">125</span></h4>
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <div class="d-inline-flex align-items-center gap-3">
                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#add_product"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add
                                Product</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn btn-outline-light shadow px-2"
                                        data-bs-toggle="dropdown" data-bs-auto-close="outside"><i
                                            class="ti ti-filter me-2"></i>Filter<i
                        ...
                        <div class="table-responsive custom-table">
                            <table class="table table-nowrap" id="products-list">
...
<script src="{{ asset('assets/json/products-list.js') }}"></script>
@endpush
