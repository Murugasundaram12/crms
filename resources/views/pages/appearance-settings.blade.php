...
@section('title', 'Settings - Appearence')
							...
							<div class="card-body">
								<div class="settings-sidebar">
									...
									<div class="list-group list-group-flush settings-sidebar">
										...
										<a href="{{ route('page', ['slug' => 'appearance-settings']) }}" class="d-block p-2 fw-medium active">Appearance</a>
					...
					<div class="col-xl-9 col-lg-12">
						...
						<div class="card mb-0">
							<div class="card-body">
								...
								<form action="https://crms.dreamstechnologies.com/html/template/appearance-settings.html">
												...
												<div class="mb-3">
													<div class="theme-type-images d-flex align-items-center gap-2">
														<div class="theme-image  text-center p-2 rounded active">
															<div class="mb-2">
																<img src="{{ asset('assets/img/theme/theme-01.jpg') }}" alt="Img">
															</div>
															<span class="fw-medium">Light</span>
														</div>
														<div class="theme-image text-center p-2 rounded">
															<div class="mb-2">
																<img src="{{ asset('assets/img/theme/theme-02.jpg') }}" alt="Img">
															</div>
															<span class="fw-medium">Dark</span>
														</div>
														<div class="theme-image text-center p-2 rounded">
															<div class="mb-2">
																<img src="{{ asset('assets/img/theme/theme-03.jpg') }}" alt="Img">
															</div>
