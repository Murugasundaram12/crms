                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to apply a stripe via CSS gradient over the progress barÃ¢â‚¬â„¢s background color.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Add <code>.bg-primary-gradient</code> to any <code>.progress-bar</code> to apply a CSS gradient over the progress barÃ¢â‚¬â„¢s background color.</p>
