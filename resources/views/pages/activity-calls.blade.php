                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <a href="{{ route('page', ['slug' => 'activity-calls']) }}" class="btn btn-icon btn-outline-light shadow active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Calls"><i class="ti ti-phone"></i></a>
                                <a href="{{ route('page', ['slug' => 'activity-mail']) }}" class="btn btn-icon btn-outline-light shadow" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Mail"><i class="ti ti-mail"></i></a>
                                <a href="{{ route('page', ['slug' => 'activity-task']) }}" class="btn btn-icon btn-outline-light shadow" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Task"><i class="ti ti-subtask"></i></a>
                                <a href="{{ route('page', ['slug' => 'activity-meeting']) }}" class="btn btn-icon btn-outline-light shadow" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Meeting"><i class="ti ti-user-share"></i></a>
                                <div class="dropdown">
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="activity-calls">
...
<script src="{{ asset('assets/json/activity-calls.js') }}"></script>
@endpush
