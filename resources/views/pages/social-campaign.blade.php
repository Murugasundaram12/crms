...
<!-- Page Header -->
                ...
                <div class="campaign-tab">
                    <ul class="nav nav-tabs nav-bordered mb-4">
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'social-campaign']) }}" class="nav-link active bg-transparent text-primary">Active Campaign</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-nowrap custom-table">
                            <table class="table table-nowrap" id="social-campaign-list">
...
<script src="{{ asset('assets/json/social-campaign.js') }}"></script>
@endpush
