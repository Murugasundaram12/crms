                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>For custom Bootstrap form validation messages, youÃ¢â‚¬â„¢ll need to add the <code>novalidate</code> boolean attribute to your form. For server side validation <a href="https://getbootstrap.com/docs/4.1/components/forms/#server-side" target="_blank" class="text-primary">read full documentation</a>.</p>
