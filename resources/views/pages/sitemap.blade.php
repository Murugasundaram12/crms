...
@section('title', 'Settings - Sitemap')
				...
				<div class="card border-0">
					<div class="card-body pb-0 pt-0 px-2">
						<ul class="nav nav-tabs nav-bordered nav-bordered-primary">
							...
							<li class="nav-item">
								<a href="{{ route('page', ['slug' => 'storage']) }}" class="nav-link p-2 active">
							...
							<div class="card-body">
								<div class="settings-sidebar">
									...
									<div class="list-group list-group-flush settings-sidebar">
										<a href="{{ route('page', ['slug' => 'sitemap']) }}" class="d-block p-2 fw-medium active">Sitemap</a>
