...
<!-- Page Header -->
                ...
                <div class="campaign-tab">
                    <ul class="nav nav-tabs nav-bordered mb-4">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'sms-campaign-completed']) }}" class="nav-link bg-transparent">Completed Campaign</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'sms-campaign-archieved']) }}" class="nav-link active bg-transparent text-primary">Archived Campaign</a>
                        </li>
                    </ul>
                </div>
                <!-- Campaign Tab -->
                ...
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-nowrap custom-table">
                            <table class="table table-nowrap" id="smscampaign-archieved">
...
<script src="{{ asset('assets/json/smscampaingn-archieved.js') }}"></script>
@endpush
