...
@section('title', 'Proposal Conversion Rate Report')

@section('content')
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Proposal Conversion Rate <span class="badge badge-soft-primary ms-2">15</span></h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item" aria-current="page">Document Reports</li>
                                <li class="breadcrumb-item active" aria-current="page">Proposal Conversion Rate </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="card-body pb-2">
                        <div class="fs-16 fw-bold mb-1 text-dark">Proporsal Conversion Trend</div>
                        <p class="mb-0"> Monthly conversion performance over the year</p>
                        <div id="proposal-conversion-rate-chart"></div>
                        <div class="d-flex align-items-center justify-content-center gap-3">
                            <p class="d-flex align-items-center gap-2 text-info"> <span><i class="ti ti-point-filled fs-20 d-flex align-items-center"></i></span> Total Proporsal </p>
                            <p class="d-flex align-items-center gap-2 text-success"> <span><i class="ti ti-point-filled fs-20 d-flex align-items-center"></i></span> Conversions </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-nowrap custom-table">
                            <table class="table table-nowrap" id="proposal-conversion-rate">
...
<script src="{{ asset('assets/json/proposal-conversion-rate.js') }}"></script>
@endpush
