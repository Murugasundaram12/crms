...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">SMS Campaign<span class="badge badge-soft-primary ms-2">200</span></h4>
                ...
                <!-- row start -->
                <div class="row camp-card-row">
                    <div class="col-xxl-3 col-xl-3 col-md-6 col-sm-6">
                        <div class="card shadow camp-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-lg rounded-circle bg-soft-secondary border border-secondary text-secondary fs-24 flex-shrink-0 "><i class="ti ti-brand-campaignmonitor fs-24"></i></span>
                                        <div>
                                            <h4 class="mb-1 fs-16">474</h4>
                                            <p class="mb-0 text-truncate">Campaign</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-md-6 col-sm-6">
                        <div class="card shadow camp-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-lg rounded-circle bg-soft-info fs-24 flex-shrink-0 border border-info text-info"><i class="ti ti-send fs-24"></i></span>
                                        <div>
                                            <h4 class="mb-1 fs-16">454</h4>
                                            <p class="mb-0 text-truncate">Sent</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-md-6 col-sm-6">
                        <div class="card shadow camp-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-lg rounded-circle bg-soft-pink fs-24 flex-shrink-0 border border-pink text-pink"><i class="ti ti-brand-feedly fs-24"></i></span>
                                        <div>
                                            <h4 class="mb-1 fs-16">650</h4>
                                            <p class="mb-0 text-truncate">Opened</p>
                                        </div>
                                    </div>
                                    <span class="badge badge-soft-danger">-3.14%</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-md-6 col-sm-6">
                        <div class="card shadow camp-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-lg rounded-circle bg-soft-success fs-24 flex-shrink-0 border border-success text-success"><i class="ti ti-checks fs-24"></i></span>
                                        <div>
                                            <h4 class="mb-1 fs-16">490</h4>
                                            <p class="mb-0 text-truncate">Completed</p>
                                        </div>
                                    </div>
                ...
                <div class="campaign-tab">
                    <ul class="nav nav-tabs nav-bordered mb-4">
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'sms-campaign']) }}" class="nav-link bg-transparent">Active Campaign</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'sms-campaign-completed']) }}" class="nav-link active bg-transparent text-primary">Completed Campaign</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'sms-campaign-archieved']) }}" class="nav-link bg-transparent">Archived Campaign</a>
                        </li>
                    </ul>
                </div>
                <!-- Campaign Tab -->
                ...
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-nowrap custom-table">
                            <table class="table table-nowrap" id="smscampaign-completed">
...
<script src="{{ asset('assets/json/smscampaingn-completed.js') }}"></script>
@endpush
