...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Pages<span class="badge badge-soft-primary ms-2">152</span></h4>
                ...
                <div class="card border-0 rounded-0">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <a href="{{ route('page', ['slug' => 'add-page']) }}" class="btn btn-primary"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add New Page</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                                        ...
                                        <div class="filter-set-view p-3">                                            
                                            <div class="accordion" id="accordionExample">
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Title</a>
                                                    </div>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="{{ route('page', ['slug' => 'pages']) }}" class="btn btn-primary w-100">Filter</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
						...
						<div class="table-responsive custom-table">
							<table class="table table-nowrap" id="pages">
...
<script src="{{ asset('assets/json/pages-list.js') }}"></script>
@endpush
