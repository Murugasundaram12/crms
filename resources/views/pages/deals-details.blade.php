...
<!-- Page Header -->
                ...
                <div class="row">
					<div class="col-md-12">
						...
						<div class="mb-3">
							<a href="{{ route('page', ['slug' => 'deals']) }}"><i class="ti ti-arrow-narrow-left me-1"></i>Back to Deals</a>
						</div>
							...
							<div class="card-body pb-2">
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<div class="d-flex align-items-center mb-2">
										...
										<div>
											<h5 class="mb-1">Tremblay and Rath <i class="ti ti-star-filled text-warning"></i></h5>
											<p class="mb-1"><i class="ti ti-building-skyscraper me-1"></i>Google Inc</p>
									...
									<div class="d-flex align-items-center flex-wrap gap-2">
										...
										<div class="dropdown">
											<a href="#" class="btn btn-xs btn-success fs-12 py-1 px-2 fw-medium d-inline-flex align-items-center" data-bs-toggle="dropdown" aria-expanded="false"> <i class="ti ti-thumb-up me-1"></i>Won<i class="ti ti-chevron-down ms-1"></i> </a>
						...
						<div class="card">
							<div class="card-body p-3">
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									...
									<a href="javascript:void(0);" class="link-primary mb-3" data-bs-toggle="modal" data-bs-target="#owner"><i class="ti ti-plus me-1"></i>Add New</a>
								</div>
								<div class="mb-3">
									<div class="d-flex align-items-center">
										<span class="avatar avatar-xs rounded-circle me-2">
											<img src="{{ asset('assets/img/users/avatar-3.jpg') }}" alt="Img" class="img-fluid rounded-circle w-auto h-auto">
										</span>
										<div>
								...
								<div class="border-bottom mb-3 pb-3">
									<div class="d-flex align-items-center">
										<span class="avatar avatar-xs rounded-circle me-2">
											<img src="{{ asset('assets/img/users/avatar-4.jpg') }}" alt="Img" class="img-fluid rounded-circle w-auto h-auto">
										</span>
										<div>
								...
								<div class="d-flex align-items-center justify-content-between mb-0">
									...
									<div class="d-flex align-items-center">
										<span class="avatar avatar-xs rounded-circle me-2">
											<img src="{{ asset('assets/img/users/avatar-2.jpg') }}" alt="Img" class="img-fluid rounded-circle w-auto h-auto">
										</span>
										<div>
										...
										<div class="card border shadow-none mb-3">
											<div class="card-body p-3">
												<div class="d-flex flex-wrap row-gap-2">
													...
													<div>
														<h6 class="fw-medium fs-14 mb-1">Denwar responded to your appointment schedule by call at 09:30pm.</h6>
										...
										<div class="card border shadow-none mb-3">
											<div class="card-body p-3">
												<div class="d-flex flex-wrap row-gap-2">
													...
													<div>
														<h6 class="fw-medium mb-1 d-inline-flex align-items-center fs-14 flex-wrap">Meeting With <span class="avatar avatar-xs rounded mx-2"><img src="{{ asset('assets/img/profiles/avatar-19.jpg') }}" alt="img"></span> Abraham</h6>
												...
												<div class="d-flex flex-lg-nowrap flex-wrap row-gap-2">
													...
													<div>
														...
														<p class="mb-1">A product team meeting is a gathering of the
															cross-functional product team Ã¢â‚¬â€ ideally including team
                                                            ...
                                                            <div class="card bg-light">
                                                                <div class="card-body p-2">
                                                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                                                        <div class="d-flex align-items-center me-3">
                                                                            <span class="avatar bg-success me-2">
                                                                                <img src="{{ asset('assets/img/media/media-35.jpg') }}" alt="img">
                                                                            </span>
                                                                            <div>
