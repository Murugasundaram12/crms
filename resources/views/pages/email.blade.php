                            ...
                            <div class="border bg-white rounded p-2 mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="fs-14 mb-0"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a5cfc4c8c0d6e5c0ddc4c8d5c9c08bc6cac8">[email&#160;protected]</a></p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="input-group input-group-sm input-group-flat me-2">
                                                <span class="input-group-text border border-end-0 shadow-none">
                                                    <i class="ti ti-search"></i>
                                                </span>
                                                <input type="text" class="form-control shadow-none" placeholder="Search..." autocomplete="off">
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-filter-edit"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-settings"></i></a>
                                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle"><i class="ti ti-refresh"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="list-group list-group-flush mails-list">
                                    ...
                                    <div class="list-group-item p-3">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                                <a href="{{ route('page', ['slug' => 'email-reply']) }}" class="avatar bg-primary avatar-rounded me-2">
                                                    <span class="avatar-title">CD</span>
                                                </a>
                                                <div class="flex-fill">
                                                    <div class="d-flex align-items-start justify-content-between">
                                                        <div>
                                                            <h6 class="fs-16 mb-1"><a href="{{ route('page', ['slug' => 'email-reply']) }}">Justin Lapoint</a></h6>
                                                            <span class="fw-semibold">Client Dashboard</span>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="dropdown">
                                                                <button class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                                    <i class="ti ti-dots"></i>
                                                                </button>
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li>
                                                                        <a class="dropdown-item rounded-1" href="{{ route('page', ['slug' => 'email-reply']) }}">Open Email</a>
                                                                    </li>
                                                                    <li>
                                    ...
                                    <div class="list-group-item p-3">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                                <a href="{{ route('page', ['slug' => 'email-reply']) }}" class="avatar avatar-md avatar-rounded me-2">
                                                    <img src="{{ asset('assets/img/profiles/avatar-01.jpg') }}" alt="Img">
                                                </a>
                                                <div class="flex-fill">
                                                    <div class="d-flex align-items-start justify-content-between">
                                                        <div>
                                                            <h6 class="fs-16 mb-1"><a href="{{ route('page', ['slug' => 'email-reply']) }}">Rufana Joe</a></h6>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <a href="javascript:void(0);"><img src="{{ asset('assets/img/icons/google-meet.svg') }}" alt="Img"></a>
                                            <div class="d-flex align-items-center">
                                                <span><i class="ti ti-star-filled text-warning"></i></span>
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                                ...
                                                <div class="flex-fill">
                                                    <div class="d-flex align-items-start justify-content-between">
                                                        <div>
                                                            <h6 class="fs-16 mb-1"><a href="{{ route('page', ['slug' => 'email-reply']) }}">Cameron Drake</a></h6>
                                                            <span class="fw-semibold">YouÃ¢â‚¬â„¢re missing</span>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="dropdown">
                                                                <button class="btn btn-icon btn-sm btn-outline-white border-0 rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <p class="mb-0">Here are a few catchy email subject line examplesÃ‚Â </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                                ...
                                                <div class="flex-fill">
                                                    <div class="d-flex align-items-start justify-content-between">
                                                        <div>
                                                            <h6 class="fs-16 mb-1"><a href="{{ route('page', ['slug' => 'email-reply']) }}">Sean Hill</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                                ...
                                                <div class="flex-fill">
                                                    <div class="d-flex align-items-start justify-content-between">
                                                        <div>
                                                            <h6 class="fs-16 mb-1"><a href="{{ route('page', ['slug' => 'email-reply']) }}">Kevin Alley</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                                ...
                                                <div class="flex-fill">
                                                    <div class="d-flex align-items-start justify-content-between">
                                                        <div>
                                                            <h6 class="fs-16 mb-1"><a href="{{ route('page', ['slug' => 'email-reply']) }}">Linda Zimmer</a></h6>
                                    ...
                                    <div class="list-group-item p-3">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                                <a href="{{ route('page', ['slug' => 'email-reply']) }}" class="avatar bg-success avatar-rounded me-2">
                                                    <span class="avatar-title">ER</span>
                                                </a>
                                                <div class="flex-fill">
                                                    <div class="d-flex align-items-start justify-content-between">
                                                        <div>
                                                            <h6 class="fs-16 mb-1"><a href="{{ route('page', ['slug' => 'email-reply']) }}">Emly Reachel</a></h6>
