                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">
                                    Any single <code>.btn</code> can be turned into a dropdown toggle with some markup changes. HereÃ¢â‚¬â„¢s  how you can put them to work with either <code>&lt;button&gt;</code> elements:
                                </p>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Place any freeform text within a dropdown menu with text and use spacing utilities. Note that youÃ¢â‚¬â„¢ll likely need additional sizing styles to constrain the menu width.</p>
