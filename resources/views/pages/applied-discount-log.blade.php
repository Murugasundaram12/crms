...
@section('title', 'Applied Discount Log')

@section('content')
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Applied Discount Log <span class="badge badge-soft-primary ms-2">10</span></h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item" aria-current="page">Sales Settings</li>
                                <li class="breadcrumb-item active" aria-current="page">Applied Discount Log </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_discount"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add Discount Log</a>
                    </div>
                    <div class="card-body">
                        <!-- table header -->
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="filter-set-content">
                                                    <div class="filter-set-content-head">
                                                        <a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Requested By</a>
                                                    </div>
                                                            ...
                                                            <ul class="mb-0">
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        ...
                                                                        <span class="avatar avatar-xs avatar-rounded me-2"><img src="{{ asset('assets/img/users/user-01.jpg') }}" alt="Img"></span>
                                                                        Albert Morgan
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-2" type="checkbox"> 
                                                                        <span class="avatar avatar-xs avatar-rounded me-2"><img src="{{ asset('assets/img/users/user-40.jpg') }}" alt="Img"></span>
                                                                        Katherine Brooks
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-2" type="checkbox"> 
                                                                        <span class="avatar avatar-xs avatar-rounded me-2"><img src="{{ asset('assets/img/users/user-02.jpg') }}" alt="Img"></span>
                                                                        Samantha Reed
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-2" type="checkbox"> 
                                                                        <span class="avatar avatar-xs avatar-rounded me-2"><img src="{{ asset('assets/img/users/user-03.jpg') }}" alt="Img"></span>
                                                                        William Anderson
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-2" type="checkbox"> 
                                                                        <span class="avatar avatar-xs avatar-rounded me-2"><img src="{{ asset('assets/img/users/user-04.jpg') }}" alt="Img"></span>
                                                                        Jonathan Mitchell
                                                                    </label>
                                                                </li>
                                                                <li>
                                                    ...
                                                    <div class="filter-set-contents accordion-collapse collapse" id="collapseStatus" data-bs-parent="#accordionExample">
                                                        <div class="filter-content-list bg-light rounded border p-1 shadow mt-2">
                                                            <ul class="mb-0">
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox"> Approved
                                                                    </label>
                                                                </li>
                                                                <li>
                                                                    <label class="dropdown-item px-2 d-flex align-items-center">
                                                                        <input class="form-check-input m-0 me-1" type="checkbox"> Rejected
                                                                    </label>
                                                                </li>
                                                            </ul>
                                                        </div>
                        ...
                        <div class="table-responsive table-nowrap custom-table">
                            <table class="table table-nowrap" id="applied-discount-log">
...
<script src="{{ asset('assets/json/applied-discount-log.js') }}"></script>
@endpush
