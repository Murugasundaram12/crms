                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Traditional heading elements are designed to work best in the meat of your page content. When you need a heading to stand out, consider using a display headingÃ¢â‚¬â€a larger, slightly more opinionated heading style.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Align terms and descriptions horizontally by using our grid systemÃ¢â‚¬â„¢s predefined classes (or semantic mixins). For longer terms, you can optionally add a <code>.text-truncate</code> class to truncate the text with an ellipsis.</p>
                                <dl class="row mb-0">
