...
@section('title', 'Email Campaign Archieved')
...
<!-- Page Header -->
                ...
                <div class="campaign-tab">
                    <ul class="nav nav-tabs nav-bordered mb-4">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('page', ['slug' => 'email-campaign-archieved']) }}" class="nav-link active bg-transparent text-primary">Archived Campaign</a>
                        </li>
                    </ul>
                </div>
                <!-- Campaign Tab -->
...
<script src="{{ asset('assets/json/email-campaign-archieved.js') }}"></script>
@endpush
