...
@section('title', 'Create Labour Role')
...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
        <div>
            <h4 class="mb-1">Create Labour Role</h4>
    ...
    <form action="{{ route('labour_roles.store') }}" method="POST" class="row g-4">
        @csrf
        ...
        <div class="col-xl-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 pb-0">
                    ...
                    <p class="text-muted fs-13 mb-0">Add the salary settings for this labour role.</p>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
