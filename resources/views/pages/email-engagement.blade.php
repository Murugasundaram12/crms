...
@section('title', 'Email Engagement Summary')
...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Email Engagement Summary <span class="badge badge-soft-primary ms-2">125</span></h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Email Engagement Summary  </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card border-0 rounded-0">
                    ...
                    <div class="card-body">
						...
						<div class="table-responsive custom-table">
							<table class="table table-nowrap" id="email-engagement">
...
<script src="{{ asset('assets/json/email-engagement.js') }}"></script>
@endpush
