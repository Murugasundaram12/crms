...
@section('title', 'Leave Balance Summary Report')

@section('content')
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Leave Balance Summary <span class="badge badge-soft-primary ms-2">10</span></h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item" aria-current="page">HRM Reports</li>
                                <li class="breadcrumb-item active" aria-current="page">Leave Balance Summary </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="row row-gap-3 mb-4">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden mb-0 border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between flex-xl-nowrap gap-2 mb-2 pb-2 border-bottom">
                                    <div>
                                        <div class="avatar rounded-lg bg-success text-white fs-20">
                                            <i class="ti ti-sort-ascending-2"></i>
                                        </div>
                                        <p class="text-dark mt-1  mb-0 fs-13 fw-medium">Total Allocated</p>
                                    </div>
                                    <div id="leave-balance-report-chart-1"></div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <h2 class="fs-28 text-success mb-0">254</h2>
                                    <span class="badge badge-soft-success border-0 rounded-pill px-3 py-2">Active</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card overflow-hidden mb-0 border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2 pb-2 border-bottom">
                                    <div>
                                        <div class="avatar rounded-lg bg-pink text-white fs-20">
                                            <i class="ti ti-user-x"></i>
                                        </div>
                                        <p class="text-dark mt-1  mb-0 fs-13 fw-medium">Leave Used</p>
                                    </div>
                                    <div id="leave-balance-report-chart-2"></div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <h2 class="fs-28 text-pink mb-0">37</h2>
                                    <span class="badge badge-soft-pink border-0 rounded-pill px-3 py-2">In Use</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden mb-0 border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2 pb-2 border-bottom">
                                    <div>
                                        <div class="avatar rounded-lg bg-purple text-white fs-20">
                                            <i class="ti ti-brand-gravatar"></i>
                                        </div>
                                        <p class="text-dark mt-1  mb-0 fs-13 fw-medium">Available Leave</p>
                                    </div>
                                    <div id="leave-balance-report-chart-3"></div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <h2 class="fs-28 text-purple mb-0">204</h2>
                                    <span class="badge badge-soft-purple border-0 rounded-pill px-3 py-2">Available</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden mb-0 border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2 pb-2 border-bottom">
                                    <div>
                                        <div class="avatar rounded-lg bg-danger text-white fs-20">
                                            <i class="ti ti-clock-share"></i>
                                        </div>
                                        <p class="text-dark mt-1 mb-0 fs-13 fw-medium">Pending Request</p>
                                    </div>
                                    <div id="leave-balance-report-chart-4"></div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <h2 class="fs-28 text-danger mb-0">6</h2>
                                    <span class="badge badge-soft-danger border-0 rounded-pill px-3 py-2">Pending</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            <div class="d-flex align-items-center gap-2 flex-wrap">     
                                ...
                                <!-- 1nd Drop down -->
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn btn-outline-light shadow px-2" data-bs-toggle="dropdown" data-bs-auto-close="outside"><i class="ti ti-outbound me-2"></i>Leave Type<i class="ti ti-chevron-down ms-2"></i></a>
                        ...
                        <div class="table-responsive table-nowrap custom-table">
                            <table class="table table-nowrap" id="leave-balance-summary-report">
...
<script src="{{ asset('assets/json/leave-balance-summary-report.js') }}"></script>
@endpush
