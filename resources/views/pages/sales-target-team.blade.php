...
<!-- Page Header -->
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Sales Target<span class="badge badge-soft-primary ms-2">150</span></h4>
                ...
                <ul class="nav nav-tabs nav-bordered mb-4" role="tablist">
                    <li class="nav-item">
                        <a href="{{ route('page', ['slug' => 'sales-target']) }}" class="nav-link border-3 bg-transparent">
                            <span class="d-md-inline-block">User</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('page', ['slug' => 'sales-target-team']) }}" class="nav-link border-3 bg-transparent active">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive custom-table table-nowrap">
                            <table class="table table-nowrap" id="sales-target-team">
...
<script src="{{ asset('assets/json/sales-target-team.js') }}"></script>
@endpush
