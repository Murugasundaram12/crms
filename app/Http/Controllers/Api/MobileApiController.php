...
class MobileApiController extends Controller
{
    ...
    protected function employeeExpensePayload(Expense $expense): array
    {
        return [
            ...
            'paid_amt' => round((float) $expense->paid_amt, 2),
            'unpaid_amt' => round((float) $expense->unpaid_amt, 2),
            'extra_amt' => round((float) $expense->extra_amt, 2),
    ...
    protected function walletPayload(Wallet $wallet): array
    {
        return [
            ...
            'amount' => round((float) $wallet->amount, 2),
