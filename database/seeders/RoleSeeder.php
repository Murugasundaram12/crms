...
class RoleSeeder extends Seeder
{
    private const ROLE_PERMISSIONS = [
        ...
        'Manager' => [
            ...
            'projects-delete',
            'payment-stages-list',
            'payment-stages-create',
            'payment-stages-edit',
            'payment-stages-delete',
            'leave-requests-list',
            ...
            'labours-edit',
            'labours-delete',
            'labour-assignments-list',
            'labour-assignments-create',
            'labour-assignments-edit',
            'labour-assignments-delete',
            'main-categories-list',
            'main-categories-create',
            'main-categories-edit',
            'main-categories-delete',
            'categories-list',
            'categories-create',
            'categories-edit',
            'categories-delete',
