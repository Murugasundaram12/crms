...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $settings = [
            ...
            ['group' => 'tracking', 'key' => 'minimum_distance_meters', 'value' => '5', 'type' => 'integer', 'description' => 'Minimum distance before saving a new point.'],
            ['group' => 'tracking', 'key' => 'max_accuracy_meters', 'value' => '1000', 'type' => 'integer', 'description' => 'Maximum accepted GPS accuracy for storing raw tracking points. Timeline display uses a stricter filter.'],
